...
//
// Command line options: -i rv32imc -c 1 -a -p rvfimon
...
module rvfimon (
  ...
  task ch0_handle_error;
    ...
    input [511:0] msg;
    begin
      $display("-------- RVFI Monitor error %0d in channel 0: %m at time %0t --------", code,
               $time);
  ...
  task ro0_handle_error_p;
    ...
    input [511:0] msg;
    begin
      $display("-------- RVFI Monitor error %0d in reordered channel 0: %m at time %0t --------",
               code, $time);
      $display("Error message: %0s", msg);
...
module rvfimon_rob (
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      if (i0_valid) begin
        if (valid[i0_order[7:0]]) errcode <= 60000 + i0_order[7:0];
        buffer[i0_order[7:0]] <= {i0_data, i0_order};
        valid[i0_order[7:0]]  <= 1;
      end
      if (continue_flag && valid[cursor[7:0]]) begin
        if (buffer[cursor[7:0]][63:0] != cursor) errcode <= 61000 + cursor[7:0];
        o0_valid <= 1;
...
module rvfimon_isa_spec (
  ...
  rvfimon_insn_c_addi insn_c_addi (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_addi16sp insn_c_addi16sp (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_addi4spn insn_c_addi4spn (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_andi insn_c_andi (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_beqz insn_c_beqz (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_bnez insn_c_bnez (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_jalr insn_c_jalr (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_lwsp insn_c_lwsp (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_slli insn_c_slli (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_srai insn_c_srai (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_srli insn_c_srli (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
  ...
  rvfimon_insn_c_swsp insn_c_swsp (
      .rvfi_valid(rvfi_valid),
      .rvfi_insn(rvfi_insn),
      .rvfi_pc_rdata(rvfi_pc_rdata),
      .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
module rvfimon_insn_auipc (
  ...
  // AUIPC instruction
  assign spec_valid = rvfi_valid && !insn_padding && insn_opcode == 7'b0010111;
  assign spec_rd_addr = insn_rd;
...
module rvfimon_insn_beq (
  ...
  wire [32-1:0] insn_padding = rvfi_insn >> 16 >> 16;
  wire [32-1:0] insn_imm = $signed(
      {rvfi_insn[31], rvfi_insn[7], rvfi_insn[30:25], rvfi_insn[11:8], 1'b0}
  );
  wire [4:0] insn_rs2 = rvfi_insn[24:20];
  wire [4:0] insn_rs1 = rvfi_insn[19:15];
  wire [2:0] insn_funct3 = rvfi_insn[14:12];
...
module rvfimon_insn_c_addi (
  ...
  // C_ADDI instruction
  wire [32-1:0] result = rvfi_rs1_rdata + insn_imm;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b000 && insn_opcode == 2'b01;
  assign spec_rs1_addr = insn_rs1_rd;
  assign spec_rd_addr = insn_rs1_rd;
  assign spec_rd_wdata = spec_rd_addr ? result : 0;
  assign spec_pc_wdata = rvfi_pc_rdata + 2;
...
module rvfimon_insn_c_addi16sp (
    input                rvfi_valid,
    input [32   - 1 : 0] rvfi_insn,
    input [32   - 1 : 0] rvfi_pc_rdata,
    input [32   - 1 : 0] rvfi_rs1_rdata,
  ...
  wire [32-1:0] insn_padding = rvfi_insn >> 16;
  wire [32-1:0] insn_imm = $signed(
      {rvfi_insn[12], rvfi_insn[4:3], rvfi_insn[5], rvfi_insn[2], rvfi_insn[6], 4'b0}
  );
  wire [2:0] insn_funct3 = rvfi_insn[15:13];
  wire [4:0] insn_rs1_rd = rvfi_insn[11:7];
  wire [1:0] insn_opcode = rvfi_insn[1:0];
...
module rvfimon_insn_c_addi4spn (
    input                rvfi_valid,
    input [32   - 1 : 0] rvfi_insn,
    input [32   - 1 : 0] rvfi_pc_rdata,
    input [32   - 1 : 0] rvfi_rs1_rdata,
...
module rvfimon_insn_c_beqz (
  ...
  wire [32-1:0] insn_padding = rvfi_insn >> 16;
  wire [32-1:0] insn_imm = $signed(
      {rvfi_insn[12], rvfi_insn[6:5], rvfi_insn[2], rvfi_insn[11:10], rvfi_insn[4:3], 1'b0}
  );
  wire [2:0] insn_funct3 = rvfi_insn[15:13];
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b110 && insn_opcode == 2'b01;
  assign spec_rs1_addr = insn_rs1;
  assign spec_pc_wdata = next_pc;
...
module rvfimon_insn_c_bnez (
  ...
  wire cond = rvfi_rs1_rdata != 0;
  wire [32-1:0] next_pc = cond ? rvfi_pc_rdata + insn_imm : rvfi_pc_rdata + 2;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b111 && insn_opcode == 2'b01;
  assign spec_rs1_addr = insn_rs1;
  assign spec_pc_wdata = next_pc;
  assign spec_trap = (next_pc[0] != 0) || !misa_ok;
...
module rvfimon_insn_c_j (
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b101 && insn_opcode == 2'b01;
  assign spec_pc_wdata = next_pc;
...
module rvfimon_insn_c_jal (
  ...
  // C_JAL instruction
  wire [32-1:0] next_pc = rvfi_pc_rdata + insn_imm;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b001 && insn_opcode == 2'b01;
  assign spec_rd_addr = 5'd1;
...
module rvfimon_insn_c_li (
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b010 && insn_opcode == 2'b01;
  assign spec_rd_addr = insn_rs1_rd;
  assign spec_rd_wdata = spec_rd_addr ? result : 0;
  assign spec_pc_wdata = rvfi_pc_rdata + 2;
...
module rvfimon_insn_c_lw (
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b010 && insn_opcode == 2'b00;
  assign spec_rs1_addr = insn_rs1;
  assign spec_rd_addr = insn_rd;
...
module rvfimon_insn_c_sw (
  ...
  // C_SW instruction
  wire [32-1:0] addr = rvfi_rs1_rdata + insn_imm;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b110 && insn_opcode == 2'b00;
  assign spec_rs1_addr = insn_rs1;
  assign spec_rs2_addr = insn_rs2;
  assign spec_mem_addr = addr & ~(32 / 8 - 1);
...
module rvfimon_insn_c_swsp (
  ...
  // C_SWSP instruction
  wire [32-1:0] addr = rvfi_rs1_rdata + insn_imm;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct3 == 3'b110 && insn_opcode == 2'b10;
  assign spec_rs1_addr = 2;
  assign spec_rs2_addr = insn_rs2;
  assign spec_mem_addr = addr & ~(32 / 8 - 1);
  assign spec_mem_wmask = ((1 << 4) - 1) << (addr - spec_mem_addr);
...
module rvfimon_insn_divu (
  ...
  // DIVU instruction
  wire [32-1:0] result = rvfi_rs2_rdata == 32'b0 ? {32{1'b1}} : rvfi_rs1_rdata / rvfi_rs2_rdata;
...
module rvfimon_insn_jal (
  ...
  wire [32-1:0] insn_padding = rvfi_insn >> 16 >> 16;
  wire [32-1:0] insn_imm = $signed(
      {rvfi_insn[31], rvfi_insn[19:12], rvfi_insn[20], rvfi_insn[30:21], 1'b0}
  );
  wire [4:0] insn_rd = rvfi_insn[11:7];
  wire [6:0] insn_opcode = rvfi_insn[6:0];
  ...
  // JAL instruction
  wire [32-1:0] next_pc = rvfi_pc_rdata + insn_imm;
  assign spec_valid = rvfi_valid && !insn_padding && insn_opcode == 7'b1101111;
  assign spec_rd_addr = insn_rd;
...
module rvfimon_insn_lui (
  ...
  // LUI instruction
  assign spec_valid = rvfi_valid && !insn_padding && insn_opcode == 7'b0110111;
  assign spec_rd_addr = insn_rd;
...
module rvfimon_insn_remu (
  ...
  // REMU instruction
  wire [32-1:0] result = rvfi_rs2_rdata == 32'b0 ? rvfi_rs1_rdata : rvfi_rs1_rdata % rvfi_rs2_rdata;

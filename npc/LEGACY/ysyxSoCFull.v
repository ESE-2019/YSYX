...
module AXI4Xbar_1 (  // rocket-chip/src/main/scala/amba/axi4/Xbar.scala:56:9
  ...
  wire       requestARIO_0_0 = ~(auto_in_araddr[27]) | auto_in_araddr[28];	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:67:97, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}
  wire       requestARIO_0_1 =
    {auto_in_araddr[28], ~(auto_in_araddr[27])} == 2'h0;	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:56:9, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}
  wire       requestAWIO_0_0 = ~(auto_in_awaddr[27]) | auto_in_awaddr[28];	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:67:97, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}
  wire       requestAWIO_0_1 =
    {auto_in_awaddr[28], ~(auto_in_awaddr[27])} == 2'h0;	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:56:9, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}
...
`endif  // ENABLE_INITIAL_REG_
  ...
  assign auto_out_1_awaddr = auto_in_awaddr[27:0];	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:56:9, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:31
  ...
  assign auto_out_1_araddr = auto_in_araddr[27:0];	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:56:9, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:31
...
module APBFanout (  // rocket-chip/src/main/scala/amba/apb/Xbar.scala:24:9
    ...
    output [31:0] auto_out_5_paddr,  // rocket-chip/src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  wire        sel_4 = auto_in_paddr[29:28] == 2'h2;	// rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}
  wire        sel_5 = auto_in_paddr[29:28] == 2'h0;	// rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}
  ...
  assign auto_out_5_paddr = auto_in_paddr;  // rocket-chip/src/main/scala/amba/apb/Xbar.scala:24:9
  ...
  assign auto_out_4_paddr = auto_in_paddr[29:0];	// rocket-chip/src/main/scala/amba/apb/Xbar.scala:24:9, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:31
...
`ifdef RANDOMIZE_REG_INIT  // src/amba/AXI4ToAPB.scala:45:25
    ...
    nodeIn_rdata_r = {
      _RANDOM[3'h3][31:17], _RANDOM[3'h4][16:0]
    };  // rocket-chip/src/main/scala/util/package.scala:88:63, src/amba/AXI4ToAPB.scala:45:25
`endif  // RANDOMIZE_REG_INIT
  end  // initial
...
`ifdef RANDOMIZE_REG_INIT  // src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    ram = {
      _RANDOM[1'h0][31:1], _RANDOM[1'h1][17:0]
...
`ifdef RANDOMIZE_REG_INIT  // rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:33:9
    ...
    r_addr = {
      _RANDOM[2'h0][31:1], _RANDOM[2'h1][0]
    };  // rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:33:9, :64:29, :65:25
    ...
    r_addr_1 = {
      _RANDOM[2'h1][31:10], _RANDOM[2'h2][9:0]
    };  // rocket-chip/src/main/scala/amba/axi4/Fragmenter.scala:33:9, :65:25
...
module ysyxSoCASIC (  // src/SoC.scala:61:9
  ...
  wire [31:0] _apbxbar_auto_out_5_paddr;  // src/SoC.scala:29:27
  ...
  APBFanout apbxbar (  // src/SoC.scala:29:27
      ...
      .auto_out_5_pready (_lsdram_apb_auto_in_pready),     // src/SoC.scala:47:60
      .auto_out_5_pslverr(_lsdram_apb_auto_in_pslverr),    // src/SoC.scala:47:60
      .auto_out_5_prdata (_lsdram_apb_auto_in_prdata),     // src/SoC.scala:47:60

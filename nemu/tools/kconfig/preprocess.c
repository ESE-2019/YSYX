...
static const struct function function_table[] = {
    ...
    {"error-if", 2, 2, do_error_if}, {"filename", 0, 0, do_filename},
    {"info", 1, 1, do_info},         {"lineno", 0, 0, do_lineno},
    {"shell", 1, 1, do_shell},       {"warning-if", 2, 2, do_warning_if},
};
...
static bool is_end_of_str(char c) { return !c; }
